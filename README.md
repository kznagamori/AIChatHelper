...
![image-20260629024801284](./Assets/image-20260629024801284.png)

**左ペインのみ表示**

![image-20260629024829491](./Assets/image-20260629024829491.png)

**右ペインのみ表示**

![image-20260629024909545](./Assets/image-20260629024909545.png)

### アプリケーション情報

右ペイン上部の情報アイコンをクリックすると、アプリケーション情報ウィンドウが開きます。バージョン情報、著作権情報、ライセンス情報などを確認できます。

![image-20260629024930238](./Assets/image-20260629024930238.png)
...
![image-20260629024956148](./Assets/image-20260629024956148.png)
